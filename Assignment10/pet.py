...
class Pet:
    ...
    def __eq__(self, other: 'Pet') -> bool:
        """
        return True if self Pet has exact name, species and birthdate as other Pet, and False otherwise
        >>> dt = Date(12, 19, 2020)
        >>> dog = Pet('Rover', 'Dog', dt)
        >>> cat = Pet('Mila', 'Cat', dt)
        >>> dogb = Pet('Rover', 'Dog', dt)
        ...
        True
        """
        return self.__name == other.__name and self.__species == other.__species and self.__birthdate == other.__birthdate